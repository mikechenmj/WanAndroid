...
interface UserApi {
    ...
    fun coinRank(@Path("page") page: Int): Call<WAndroidResponse<PageModule<User.CoinInfo>>>

    @GET("/lg/coin/userinfo/json")
    fun userCoin(@Path("page") page: Int): Call<WAndroidResponse<PageModule<User.CoinInfo>>>
